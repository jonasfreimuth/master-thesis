...
than inherent association of bulk and cancer expression. The one exception is
that, on pseudo-bulks derived from real-world samples and across parameters,
deconvPure manged to outperform the inherent association only on a single
pseudo-bulk, and that only by a small margin.
