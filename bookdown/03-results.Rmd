...
CIs). Also, while there was very little variation in accuracy
...
(significant at $\alpha = 0.05$, 95% CIs), except for the
...
statistically significant (non-overlapping 95% CIs). Here, CIs also became wider
for smaller, more restrictive thresholds.
...
only significant for the second-tightest and loosest threshold, 95% CIs).
