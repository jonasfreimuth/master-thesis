...
noise: High & equal biological noise had the same levels of accuracy, while the
low biological noise group was slightly worse, and the group with very low
biological noise had exactly zero correlation. Under the model of cancer cells
...
similar to the previous model. As mentioned, the largest improvement can be seen
when removing the cancer expression profile from the reference. Here,
correlation of true and estimated cancer expression is high across almost all
levels of biological noise except for the lowest. This extends across cancer
...
between slightly under 0.85, and slightly under 0.8 for high and equal
biological noise.
