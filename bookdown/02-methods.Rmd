...
average inverse root mean square error ($1 / \text(RMSE)$) between true and
estimated cell type concentrations, and average Pearson's $\rho$ between true
and estimated values cancer cell type expression across all deconvolutions with
