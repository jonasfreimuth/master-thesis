...
accuracy.To put the results into context, I also ran BayesPrism on the same data
again. However, as BayesPrism is not able to estimate expression for non-marker
genes, there is a possibility that differences in performances of the models
trained on the expression estimates are confounded by the differences in the
number of genes. To address this, I also trained models on bulk data with gene
sets restricted to each set of genes from the cancer expression estimates.
