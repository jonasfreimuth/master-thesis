...
noise and averaged results across replicates.
...
and contrasted across including the cancer cell type or not.
...
average Pearson's $\rho$ between true and estimated values of cancer cell type
expression across all deconvolutions with the same set of parameters.
