...
of a set 50 genes. Due to the simplicity of its definition, it should represent
a relatively easy sample property to predict, with clear differences between the
type of data used (estimated cancer expression vs. bulk). The PFI on the other
hand, is a property of the patients' disease progression. Compared to the
overall survival of the patient which may be of greater interest, it has the
advantage of greater availability of data due to shorter followup times
