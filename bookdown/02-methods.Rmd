...
(`r txt_pr_stc("thresholds")`) on marker gene scores, but again contrasting
across marker selection methods. The remaining parameters were the same as
during the [BayesPrism comparison](#comparison-to-bayesprism). To put the
