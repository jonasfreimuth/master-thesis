...
from @davies.1993], but ultimately chose a simple Wilcoxon rank-sum test
...
followup times [@liu.2018]. As predicting a clinical outcome from expression
data alone is bound to result in low accuracy, I included the age and tumor
status at diagnosis in the prediction model along with the expression data
