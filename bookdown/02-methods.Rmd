...
import::here("knitr", "include_graphics", "kable")
...
```{r workflow, fig.cap = paste(readLines(here("resources/workflow_diagram_cap.txt")), collapse = " ")}
...
<!-- TODO Characterize real-world bulk data. -->
