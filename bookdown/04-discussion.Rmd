...
high estimation accuracy, barely influenced by the amount of marker genes used
during deconvolution, could be explained by the relationship of cell type
expression profiles among each other. As seen in Supp. Figure
