...
deconvolution. Theses methods are Cibersortx [@newman.2019], BLADE
[@andradebarbosa.2021], and BayesPrism [@chu.2022]. Cibersortx accomplishes the
purification by using a multi-stage matrix factorization approach, while the
latter two methods use probabalistic approaches. 

[Cibersortx ist doof und erfordert mehr bulks als cell types, BayesPrism computationally intensive]
